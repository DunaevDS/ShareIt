...
public class ItemControllerTest {
    ...
    private final User user = new User(1, "First", "first@first.ru");

    private final Item item = new Item(1, "Item1", "Description1", true, user, null);
    private final ItemDto itemDto = new ItemDto(1, "Item1", "Description1", true,
            user, null, null, null, null);
    private final CommentDto commentDto = new CommentDto(1, "Text comment", item,
            user.getName(), LocalDateTime.of(2022, 3, 5, 1, 2, 3));

    private final List<Object> listItemDto = new ArrayList<>();

    @Test
    void createItem() throws Exception {
        when(itemService.create(any(), any(Integer.class)))
                .thenReturn(itemDto);
    ...
    void updateItem() throws Exception {
        when(itemService.update(any(), any(Integer.class)))
                .thenReturn(itemDto);
    ...
    void createComment() throws Exception {
        when(itemService.createComment(any(), any(Integer.class), any(Integer.class)))
